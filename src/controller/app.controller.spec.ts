...
describe('AppController', () => {
  ...
  describe('receiveData', () => {
    it('should generate and send XML', async () => {
      const generateAndSendXmlSpy = jest.spyOn(xmlService, 'generateAndSendXml').mockResolvedValue('');
      ...
      const result = await appController.receiveData(fecha, origen, destino, cant);
