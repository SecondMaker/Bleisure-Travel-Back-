              ...
              <OriginDestinationOptions>
                 <OriginDestinationOption>
                    <FlightSegment  DepartureDateTime="${
                      flightData.flightData.DepartureDateTime
                    }" ArrivalDateTime="${
      flightData.flightData.ArrivalDateTime
    }"  FlightNumber="${
      flightData.flightData.FlightNumber
    }" ResBookDesigCode="${priceData.priceData.ResBookDesigCode}" >
                       <DepartureAirport LocationCode="${
                         flightData.flightData.DepartureAirport
                       }" />
                       <ArrivalAirport LocationCode="${
                         flightData.flightData.ArrivalAirport
                       }" />
                       <MarketingAirline Code="${
                         flightData.flightData.MarketingAirline
                       }" />
                    </FlightSegment>
                 </OriginDestinationOption>
              </OriginDestinationOptions>
           ...
           <TravelerInfoSummary>
              <AirTravelerAvail>
                 ${
                   priceData.priceData.adt
                     ? `<PassengerTypeQuantity Code="ADT" Quantity="${priceData.priceData.adt}" />`
                     : ''
                 }
                 ${
                   priceData.priceData.chd && priceData.priceData.chd > 0
                     ? `<PassengerTypeQuantity Code="CHD" Quantity="${priceData.priceData.chd}" />`
                     : ''
                 }
                 ${
                   priceData.priceData.inf && priceData.priceData.inf > 0
                     ? `<PassengerTypeQuantity Code="INF" Quantity="${priceData.priceData.inf}" />`
                     : ''
                 }
              </AirTravelerAvail>
           </TravelerInfoSummary>
